 ...
 * reading is always the bar's real height - the docked bar is 1 + 8 + 56 + max(8, safe − 16) px on
 * iOS, i.e. 73px without a home indicator and 83px on an iPhone that has one, and 1 + 8 + 56 + 8
 * plus the inset on Android. With no footer mounted it falls back to that iPhone height.
 */
