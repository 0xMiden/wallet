...
export const BrowserScreen: FC = () => {
  ...
  // No LayoutGroup / layoutId here. We had a tile→capsule shared
  // element morph wired up via framer-motion, but its layout-tracking
  // machinery competed with TabLayout's CSS slide-in and produced a
  // visible jiggle on every Browser tab enter. Removed entirely —
  // tile and capsule render as plain HTML now.
  return mode === 'active' ? <DappActive /> : <DappLauncher onOpen={handleOpen} />;
};
