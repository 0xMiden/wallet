...
export const SeedPhraseInput: FC<SeedPhraseInputProps> = ({
  ...
  return (
    <div>
      ...
      <div
        className="flex text-center my-6 rounded-lg"
        style={{ fontSize: '14px', lineHeight: '20px', backgroundColor: '#ECF5FF', padding: '16px 28px' }}
      >
        <div>
          <span>
        ...
        <div className="flex flex-col px-2 text-left">
          <span className="text-sm font-medium">{t('seedPhraseTip')}</span>
        </div>
      </div>
