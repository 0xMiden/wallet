...
import { PageActiveContext, PageMountedByReturnContext, PageOnScreenContext, usePageActive } from './page-active';
...
describe('TabLayout — mount fade and tab panes', () => {
  ...
  it('skips the fade when a return mounted its layer', () => {
    mockLocation.pathname = '/history';
    render(
