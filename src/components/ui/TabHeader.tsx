...
/**
 * The icon button of a tab root's title row: the design system's `IconButton` in its 44px circle —
 ...
 * raised bubble means "selected" now that the segmented control fills it with the accent, and a
