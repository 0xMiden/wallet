 ...
 * for a card that stands on its own on the page. Cards sit on `page` and are separated by space;
 * hairlines otherwise only divide the rows of a group inside one surface.
 */
