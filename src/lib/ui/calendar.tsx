  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          'bg-fill text-heading-gray rounded-(--cell-radius) data-[selected=true]:rounded-none',
