...
| Section label | `SectionHeader` (*planned*) | 13px Inter bold `muted`, sentence case, 8px above its group, 4px inset. A page-level section title is 20px 800. | ~40 hand-styled headings, uppercase labels |
