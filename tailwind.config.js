  ...
  theme: {
    ...
    colors: (() => {
      ...
      const brandColors = {
        ...
        'primary-orange': baseColors.logoOrange[200],
        'primary-orange-disabled': baseColors.logoOrange[400],
        'primary-orange-light': baseColors.logoOrange[300],
        'primary-orange-dark': baseColors.logoOrange[700],
        'primary-orange-lighter': baseColors.orange[50],
        'primary-orange-darker': baseColors.orange[900],
        'primary-gray': baseColors.gray[600]
      };
